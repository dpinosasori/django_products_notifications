...
AUTH_USER_MODEL = 'products.User'  # 'users' es el nombre de tu app
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'edwinajrm@gmail.com'
EMAIL_HOST_PASSWORD = os.getenv("USER_PASSWORD")
DEFAULT_FROM_EMAIL = 'edwinajrm@gmail.com'
...
SWAGGER_SETTINGS = {
    ...
    'JSON_EDITOR': True,
    'DEFAULT_INFO': 'core.urls.swagger_info',  # Ruta a tu configuración
}